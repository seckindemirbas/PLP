...
\item Is the set $\theta = \{((x, y), (5y, 4x, x + y)) : x, y \in\mathbb{R}\}$ a function? If so, what is its domain and its range?
...
Discuss what would happen if I replaced $\mathbb Z$ with a finite set in the question? Would you be able to find such functions?
