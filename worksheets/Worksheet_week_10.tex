...
\item Prove that the function $f : \mathbb R-\set{2/5}\rightarrow \mathbb R-\set{-3/5}$ given by $f(x)=\dfrac{3x}{2-5x}$ is bijective.

\soln{

  \textbf{Proof}: Let
  $f : \mathbb R-\set{1}\rightarrow\mathbb R=\set{2}$, be defined by
  $f(x)=\dfrac{3x}{2-5x}$. Then we want to show that $f$ is both
  injetive and surjective.

\textbf{$f$ is injective}: Assume that $a,z\in\mathbb \mathbb R-\set{2/5}$, and $f(x)=f(z)$. This means that $\dfrac{3x}{2-5x}=\dfrac{3z}{2-5z}$.

Thus, we see that $(3x)(2-5z)=(3z)(2-5x)$. By expanding the products we get $6x-15xz = 6z-15zx$, which implies $x=z$. Hence, $f$ is injective.

\textbf{$f$ is surjective}: Let $y\in\mathbb R-\set{-3/5}$. Then, we want to find $x\in\mathbb R-\set{2/5}$, such that $f(x)=\dfrac{3x}{2-5x}=y$.

By solving the equation for \(x\) we need \(x=2y/(5y+3)\). Since \(y \neq -3/5\) we see that \(x\) exists. Further since (by partial fractions)
\begin{align*}
  x = \frac{2y}{5y+3} = \frac{2}{5} - \frac{6/5}{5y+3}
\end{align*}
where this last term is non-zero, we know that \(x \neq 2/5\).

We can then verify that
\begin{align*}
  f(x) &= \frac{3x}{2-5x} \\
       &= \frac{6y/(5y+3)}{2 - 10y/(5y+3)} \\
       &= \frac{6y}{10y+6-10y} = y
\end{align*}
as required.

Hence for any \(y\) in the codomain there is some \(x\) in the domain so that \(f(x)=y\). Thus \(f\) is surjective.
